...
{
    Game::getInstance()->mixer()->playFile(Audio::IMixer::Category::SFX, "sound/sfx/ib1p1xx1.acm");
}
...
{
    Game::getInstance()->mixer()->playFile(Audio::IMixer::Category::SFX, "sound/sfx/monitor.acm");
    std::string msg = "\n\x95";
    msg += message;
    *_messageLog << msg;
